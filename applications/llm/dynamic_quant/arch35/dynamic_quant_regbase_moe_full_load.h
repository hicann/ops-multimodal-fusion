 ...
 * \brief
 */
#ifndef DYNAMIC_QUANT_STORY_REGBASE_MOE_FULL_LOAD_H
#define DYNAMIC_QUANT_STORY_REGBASE_MOE_FULL_LOAD_H
...
public:
    ...
    __aicore__ inline void Process() {
        ...
        for (int32_t i = 0; i < loopCnt; i++) {
            // 更新处理row的偏移，baseRow始是0，每个loop增加multiRowNum
...
private:
    ...
    __aicore__ inline void ComputeVF(__local_mem__ xDtype* xAddr, __local_mem__ xDtype* smoothAddr,
        ...
        __VEC_SCOPE__
        {
            ...
            AscendC::MicroAPI::RegTensor<float> vreg6; // x的对值absvalue
...
#endif // DYNAMIC_QUANT_STORY_REGBASE_MOE_FULL_LOAD_H
