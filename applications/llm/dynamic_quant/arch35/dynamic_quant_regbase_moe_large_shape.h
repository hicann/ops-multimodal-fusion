 ...
 * \brief
 */
#ifndef DYNAMIC_QUANT_STORY_REGBASE_MOE_LARGE_SHAPE_H
#define DYNAMIC_QUANT_STORY_REGBASE_MOE_LARGE_SHAPE_H
    ...
    int64_t offsetBase, int32_t& groupNum)
{
    ...
    if (tilingData_.innerLoopTail > 0) { // 如果核内切的有尾
...
#endif  // DYNAMIC_QUANT_STORY_REGBASE_MOE_LARGE_SHAPE_H
