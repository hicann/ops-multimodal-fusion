 ...
 * \brief
 */
#ifndef DYNAMIC_QUANT_STORY_REGBASE_LARGE_SHAPE_DB_H
#define DYNAMIC_QUANT_STORY_REGBASE_LARGE_SHAPE_DB_H
...
#endif  // DYNAMIC_QUANT_STORY_REGBASE_LARGE_SHAPE_DB_H
